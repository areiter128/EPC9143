 ...
 * *******************************************************************************
 * User:                M91406
 * Date/Time:           02/08/2020 3:05:16 AM
 * *******************************************************************************/

#ifndef __SPECIAL_FUNCTION_LAYER_I_LOOP_B_H__
#define __SPECIAL_FUNCTION_LAYER_I_LOOP_B_H__
 ...
 * in controller source file i_loop_b.c
 *
...
// Calls the i_loop_b controller object
extern void i_loop_b_Update( // Calls the 2P2Z controller (Assembly)
        volatile cNPNZ16b_t* controller // Pointer to nPnZ data type object
    );


#endif // end of __SPECIAL_FUNCTION_LAYER_I_LOOP_B_H__
