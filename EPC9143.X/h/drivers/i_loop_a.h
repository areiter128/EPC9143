...
#ifndef __SPECIAL_FUNCTION_LAYER_I_LOOP_A_H__
#define __SPECIAL_FUNCTION_LAYER_I_LOOP_A_H__
 ...
 * in controller source file i_loop_a.c
 *
...
// Calls the i_loop_a controller object
extern void i_loop_a_Update( // Calls the 2P2Z controller (Assembly)
        volatile cNPNZ16b_t* controller // Pointer to nPnZ data type object
    );


#endif // end of __SPECIAL_FUNCTION_LAYER_I_LOOP_A_H__
