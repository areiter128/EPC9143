...
{
    0x6614, // Coefficient A1 will be multiplied with controller output u(n-1)
    0x19ED  // Coefficient A2 will be multiplied with controller output u(n-2)
};

volatile fractional i_loop_b_BCoefficients [3] =
{
    0x117E, // Coefficient B0 will be multiplied with error input e(n-0)
    0x00C7, // Coefficient B1 will be multiplied with error input e(n-1)
    0xEF49  // Coefficient B2 will be multiplied with error input e(n-2)
};

// Coefficient normalization factors
volatile int16_t i_loop_b_pre_scaler = 3;
volatile int16_t i_loop_b_post_shift_A = 0;
volatile int16_t i_loop_b_post_shift_B = 0;
