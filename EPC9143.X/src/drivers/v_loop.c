 ...
 * **********************************************************************************
 * 4p4z compensation filter coefficients derived for following operating
 * conditions:
 * **********************************************************************************
 *
 ...
 * *********************************************************************************
 * User:                M91406
 * Date/Time:           02/11/2020 12:33:58 AM
 * ********************************************************************************/
 ...
 * ********************************************************************************/
volatile fractional v_loop_ACoefficients [4] =
{
    0x2ABE, // Coefficient A1 will be multiplied with controller output u(n-1)
    0x4255, // Coefficient A2 will be multiplied with controller output u(n-2)
    0x1188, // Coefficient A3 will be multiplied with controller output u(n-3)
    0x0167  // Coefficient A4 will be multiplied with controller output u(n-4)
};

volatile fractional v_loop_BCoefficients [5] =
{
    0x4F68, // Coefficient B0 will be multiplied with error input e(n-0)
    0x8921, // Coefficient B1 will be multiplied with error input e(n-1)
    0xDC90, // Coefficient B2 will be multiplied with error input e(n-2)
    0x76ED, // Coefficient B3 will be multiplied with error input e(n-3)
    0xD416  // Coefficient B4 will be multiplied with error input e(n-4)
};
